...
The data file (.dat) for the 68-landmark detector used in the project can be found  going to "http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2" URL.
